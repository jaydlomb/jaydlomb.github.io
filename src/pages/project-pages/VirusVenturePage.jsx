...
import virusventure1 from '../../assets/images/virusventure1.png'
import virusventure2 from '../../assets/images/virusventure2.png'
import virusventure3 from '../../assets/images/virusventure3.png'
import virusventure4 from '../../assets/images/virusventure4.png'
import virusventure5 from '../../assets/images/virusventure5.png'
import virusventure6 from '../../assets/images/virusventure6.png'
import virusventure7 from '../../assets/images/virusventure7.png'
import virusventure8 from '../../assets/images/virusventure8.png'
  ...
  return (
    <Box maxW="1200px" mx="auto" py={{ base: 6, lg: 10 }} px={{ base: 4, md: 6 }}>
      ...
      <Box animation={`${fadeSlideUp} 0.6s ease-out 0.3s forwards`} opacity={0}>
        ...
        <GalleryGrid images={[
          { src: virusventure1, alt: 'Screenshot 1' },
          { src: virusventure2, alt: 'Screenshot 2' },
          { src: virusventure3, alt: 'Screenshot 3' },
          { src: virusventure4, alt: 'Screenshot 4' },
          { src: virusventure5, alt: 'Screenshot 5' },
          { src: virusventure6, alt: 'Screenshot 6' },
          { src: virusventure7, alt: 'Screenshot 7' },
          { src: virusventure8, alt: 'Screenshot 8' },
        ]} />
      </Box>
    </Box>
  )
