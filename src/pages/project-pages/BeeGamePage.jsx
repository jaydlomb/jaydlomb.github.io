...
import beegame from '../../assets/images/beegame.png'
import beegame1 from '../../assets/images/beegame1.png'
import beegame2 from '../../assets/images/beegame2.gif'
import beegame3 from '../../assets/images/beegame3.png'
import beegame4 from '../../assets/images/beegame4.gif'
import beegame5 from '../../assets/images/beegame5.png'
import beegame6 from '../../assets/images/beegame6.png'
import beegame7 from '../../assets/images/beegame7.png'
...
export default function BeeGamePage() {
  ...
  return (
    <Box maxW="1200px" mx="auto" py={{ base: 6, lg: 10 }} px={{ base: 4, md: 6 }}>
      ...
      >
        <Box flex={1} w="100%">
          <ImageLightbox src={beegame} alt="The Bee Game" />
        </Box>

        <Box flex={1}>
          <Heading fontSize={{ base: '2xl', md: '4xl' }} fontWeight="900" color="#000000" letterSpacing="tight" mb={2}>
            The Bee<Text as="span" color="#224AA0">Game</Text>
          </Heading>
          <Box w="60px" h="4px" bg="#224AA0" mb={6} />

          <Text color="#0a1628" fontSize={{ base: 'md', lg: 'lg' }} lineHeight={1.8} mb={8}>
            Bee Game is an open-world exploration game in which you play as a bee attempting to 
            rebuild their broken hive and unite the scattered bees of the yard. A game with a lens
            on activism, showing how human influence kills bees daily.by putting them into the shoes of
            a bee. 
            The player experience will include adventure and exploration, avoiding dangers, and some 
            resource management.
          </Text>
      ...
      <Box animation={`${fadeSlideUp} 0.6s ease-out 0.3s forwards`} opacity={0}>
        ...
        <GalleryGrid images={[
          { src: beegame1, alt: 'Screenshot 1' },
          { src: beegame2, alt: 'Screenshot 2' },
          { src: beegame3, alt: 'Screenshot 3' },
          { src: beegame4, alt: 'Screenshot 4' },
          { src: beegame5, alt: 'Screenshot 5' },
          { src: beegame6, alt: 'Screenshot 6' },
          { src: beegame7, alt: 'Screenshot 7' },
        ]} />
      </Box>
    </Box>
  )
