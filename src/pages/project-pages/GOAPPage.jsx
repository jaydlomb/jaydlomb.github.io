      ...
      <Flex gap={10} wrap="wrap" mb={16} animation={`${fadeSlideUp} 0.6s ease-out 0.1s forwards`} opacity={0}>
        <Box flex={1} minW="300px">
          ...
          <List.Root pl={4} spacing={1} mb={5}>
            ...
            <List.Item color="#1e3a5f" fontSize="md">Programmer - Partner</List.Item>
          </List.Root>

          <Text fontWeight="bold" color="#0a1628" mb={1}>Technology</Text>
          <List.Root pl={4} spacing={1} mb={5}>
            <List.Item color="#1e3a5f" fontSize="md">Unity, C#, NavMesh</List.Item>
          </List.Root>

          <Text fontWeight="bold" color="#0a1628" mb={1}>Duration</Text>
          <List.Root pl={4} spacing={1}>
            <List.Item color="#1e3a5f" fontSize="md">Final Project - Game AI Class</List.Item>
          </List.Root>
        </Box>
      ...
      <Flex gap={10} wrap="wrap" mb={16} animation={`${fadeSlideUp} 0.6s ease-out 0.2s forwards`} opacity={0}>
        <Box flex={1} minW="300px" bg="#e8f0fe" p={8}>
          ...
          <List.Root pl={4} spacing={2}>
            <List.Item color="#0a1628" fontSize="md">Implemented GOAP architecture</List.Item>
            <List.Item color="#0a1628" fontSize="md">Integrated NavMesh for pathfinding</List.Item>
            <List.Item color="#0a1628" fontSize="md">Co-authored research paper</List.Item>
          </List.Root>
        </Box>
        ...
        <Box flex={1} minW="300px" bg="#e8f0fe" p={8}>
          ...
          <Box w="40px" h="3px" bg="#224AA0" mb={6} />
          <List.Root pl={4} spacing={2}>
            <List.Item color="#0a1628" fontSize="md">Fix remaining bugs in action planning</List.Item>
            <List.Item color="#0a1628" fontSize="md">Add more complex goal states</List.Item>
          </List.Root>
        </Box>
      </Flex>
