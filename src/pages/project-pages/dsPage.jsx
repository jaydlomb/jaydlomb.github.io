      ...
      <Flex gap={10} wrap="wrap" mb={16} animation={`${fadeSlideUp} 0.6s ease-out 0.1s forwards`} opacity={0}>
        <Box flex={1} minW="300px">
          ...
          <List.Root pl={4} spacing={1} mb={5}>
            <List.Item color="#1e3a5f" fontSize="md">Nintendo 3DS</List.Item>
          </List.Root>
          ...
          <List.Root pl={4} spacing={1} mb={5}>
            <List.Item color="#1e3a5f" fontSize="md">C, devkitPro, libctru</List.Item>
          </List.Root>

          <Text fontWeight="bold" color="#0a1628" mb={1}>Duration</Text>
          <List.Root pl={4} spacing={1}>
            <List.Item color="#1e3a5f" fontSize="md">Final Project - Computer Architecture</List.Item>
          </List.Root>
        </Box>
      ...
      <Flex gap={10} wrap="wrap" mb={16} animation={`${fadeSlideUp} 0.6s ease-out 0.2s forwards`} opacity={0}>
        <Box flex={1} minW="300px" bg="#e8f0fe" p={8}>
          ...
          <List.Root pl={4} spacing={2}>
            <List.Item color="#0a1628" fontSize="md">Researched 3DS architecture and homebrew development</List.Item>
            <List.Item color="#0a1628" fontSize="md">Implemented touch screen drawing functionality</List.Item>
            <List.Item color="#0a1628" fontSize="md">Wrote 8-page research document</List.Item>
          </List.Root>
        </Box>
        ...
        <Box flex={1} minW="300px" bg="#e8f0fe" p={8}>
          ...
          <Box w="40px" h="3px" bg="#224AA0" mb={6} />
          <List.Root pl={4} spacing={2}>
            <List.Item color="#0a1628" fontSize="md">Add more interactive features</List.Item>
            <List.Item color="#0a1628" fontSize="md">Explore 3D rendering capabilities</List.Item>
          </List.Root>
        </Box>
      </Flex>
